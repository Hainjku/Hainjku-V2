...
┣⊱ Hᴏʟᴀ, %name﹗ 🌟
┣⊱ 👤• Uѕυαrιo Iɴғo •
┣⊱ ✨ Eхperιeɴcια: *%totalexp* XP*
┣⊱ 💰 Coins: *%limit coin(s)*
┣⊱ ⤴️ LᥱʋᥱꙆ: *%level* _(%exp / %maxexp)_
┣⊱ ⤴️ LᥱʋᥱꙆ UP: *%xp4levelup*
┣━━━━━━━━━━━━
%readmore
┣━━━━━━━━━━━━
┣⊱𝖨𝗇𝗌𝗍𝖺𝗀𝗋𝖺𝗆 𝖽𝖾𝗅 𝖽𝗎𝖾𝗇̃𝗈
┣⊱(𝖴́𝗇𝗂𝖼𝗈 𝗆𝖾́𝗍𝗈𝖽𝗈 𝖽𝖾 𝖼𝗈𝗇𝗍𝖺𝖼𝗍𝗈)
┣⊱@gastonvainstein
┣━━━━━━━━━━━━`
    ...
    conn.sendMessage(m.chat, text.trim(), MessageType.text, {
     quoted: {
        key: {
...
handler.tags = ['main']
handler.command = /^(info|wallet|billetera|monedero)$/i
handler.owner = false
handler.mods = false
