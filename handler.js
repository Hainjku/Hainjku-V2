      ...
      let isBotAdmin = bot.isAdmin || bot.isSuperAdmin || false // Are you Admin?
        ...
        if (typeof plugin.before == 'function') if (await plugin.before.call(this, m, {
          ...
          try {
            ...
            if (m.limit) m.reply(+ m.limit + ' coin ha sido descontado de tu 💰 *BANCO* por utilizar esta función, si quieres coins infinitos escribe */premium*')
          }
    			break
  	  	}
    	}
...
El usuario @${m.participant.split`@`[0]} ha borrado un mensaje!
