...
global.reloadHandler = function () {
  ...
  conn.welcome = '✳ 𝙷𝚊𝚒𝚗𝚓𝚔𝚞 ᴮᴼᵀ | *WELCOME*\n\nHola, @user!, te damos la bienvenida a@subject\n\nNo olvides leer las reglas del grupo!\n\nPara aprender a usar el bot ingresa a\n(https://gastonvainstein.online)\n\n*Grupo del bot:*\n(https://chat.whatsapp.com/JDrnUNAs0yn0WCBJDoNPnl)'
  conn.bye = '✳ 𝙷𝚊𝚒𝚗𝚓𝚔𝚞 ᴮᴼᵀ | *WELCOME*\n\nJAJAJA, adiós. Nadie te quería igual pete @user!'
